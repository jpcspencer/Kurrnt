...
export default function OnboardingPage() {
  ...
  const canProceedFromStep2 = interests.size >= 1;
              ...
              {INTERESTS.map((topic) => {
                ...
                return (
                  <button
                    key={topic}
                    type="button"
                    onClick={() => (selected ? removeInterest(topic) : toggleInterest(topic))}
                    className={`rounded-full px-4 py-2 text-sm font-medium transition-colors ${
                      selected
                        ...
                        : isDark
                          ...
                          : "border border-[#d4d4d4] text-[#111110] hover:bg-[#d4d4d4]"
                    }`}
                  >
                    {topic}
                  </button>
        ...
        {step === 4 && (
          <section className="flex w-full max-w-md flex-col items-center text-center">
            ...
            <div className="mb-6 flex w-full flex-col gap-3">
              ...
              {magicLinkSent ? (
                <p className={`text-sm ${isDark ? "text-[#edebe8]" : "text-[#111110]"}`}>
